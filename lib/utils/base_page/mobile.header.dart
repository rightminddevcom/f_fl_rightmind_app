import 'delegates/builder.delegate.dart';
import 'delegates/fadeOut.delegate.dart';
import 'delegates/fixed.delegate.dart';
import 'delegates/scale.delegate.dart';
import 'delegates/transform.delegate.dart';
import 'delegates/transition.delegate.dart';
...
class CoreHeader {
  ...
  CoreHeader.transition({
    ...
    this.elevation = 0.0,
        ...
        shrinkChild = null,
        alignment = null,
        delegate = CoreTransitionDelegate(
